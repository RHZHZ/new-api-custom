...
function StartStepItem(props: {
  ...
  return (
    <li className='relative flex gap-3 pb-2.5 last:pb-0'>
      ...
      <Link
        to={props.step.to}
        className='bg-background hover:bg-muted/50 focus-visible:ring-ring flex min-w-0 flex-1 items-center justify-between gap-3 rounded-md border px-3 py-2.5 text-left shadow-xs transition-colors outline-none focus-visible:ring-2'
      >
...
function RequestPreview(props: {
  ...
  return (
    <motion.div
      ...
      className='bg-background relative overflow-hidden rounded-lg border p-3'
    >
      ...
      <div className='bg-foreground/[0.035] my-3 rounded-md p-3 font-mono text-xs'>
...
export function OverviewDashboard() {
  ...
  return (
    <div className='flex flex-col gap-4'>
      {/* Order per enterprise site theme 16.9: account & balance summary
          first, then onboarding progress + quick actions, then content
          panels (announcements / service info). */}
      <SummaryCards />

      {setupGuideExpanded ? (
        <CardStaggerContainer className='grid items-stretch gap-4 xl:grid-cols-[minmax(0,1fr)_22rem]'>
          <CardStaggerItem className='bg-card h-full overflow-hidden rounded-lg border shadow-xs'>
            <div className='relative h-full overflow-hidden p-4 sm:p-5'>
              <div className='relative grid gap-5 lg:grid-cols-[minmax(0,1fr)_21rem]'>
                <div className='flex min-w-0 flex-col gap-5'>
                  ...
                  <ol className='bg-background rounded-lg border p-2'>
          ...
          <CardStaggerItem className='bg-card h-full rounded-lg border p-4 shadow-xs sm:p-5'>
            ...
            <div className='relative overflow-hidden px-4 py-3 sm:px-5'>
              <div className='relative flex flex-wrap items-center justify-between gap-3'>
                <div className='flex min-w-0 items-center gap-3'>
                  <span className='bg-background flex size-9 shrink-0 items-center justify-center rounded-md border shadow-xs'>
