	...
	anonymousRequestBodyLimit := middleware.AnonymousRequestBodyLimit()
	{
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/savings/lifetime", middleware.SearchRateLimit(), controller.GetUserSavingsLifetime)
		...
		systemTaskRoute.Use(middleware.RootAuth())
		{
			...
			systemTaskRoute.POST("/savings-lifetime-backfill", controller.CreateSavingsLifetimeBackfillTask)
			systemTaskRoute.GET("/savings-lifetime-backfill", controller.GetSavingsLifetimeBackfillTask)
			systemTaskRoute.POST("/savings-lifetime-backfill/pause", controller.PauseSavingsLifetimeBackfillTask)
			systemTaskRoute.POST("/savings-lifetime-backfill/resume", controller.ResumeSavingsLifetimeBackfillTask)
			systemTaskRoute.POST("/savings-lifetime-backfill/retry", controller.RetrySavingsLifetimeBackfillTask)
