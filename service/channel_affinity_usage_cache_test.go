...
func channelAffinityStatsTestKey(t *testing.T) (string, string, string) {
	t.Helper()
	name := strings.NewReplacer("/", "_", " ", "_").Replace(t.Name())
	return "rule_" + name, "default", "fp_" + name
}

func cleanupChannelAffinityUsageCacheStatsForTest(t *testing.T, ruleName, usingGroup, keyFP string) {
	t.Helper()
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName, usingGroup, keyFP := channelAffinityStatsTestKey(t)
	cleanupChannelAffinityUsageCacheStatsForTest(t, ruleName, usingGroup, keyFP)
